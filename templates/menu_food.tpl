...
<ul class="{$packageMenuClass}">
	...
	<li><a class="item" href="{$smarty.const.FOOD_PKG_URL}view_day.php">{tr}Food Diary{/tr}</a></li>
	<li><a class="item" href="{$smarty.const.FOOD_PKG_URL}list_components.php">{tr}Food Items{/tr}</a></li>
